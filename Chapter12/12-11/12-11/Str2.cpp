...
void Str2::create(std::size_t n, const char c)
{
...
void Str2::copy(char* dest, size_t amount, size_t pos)
{
	std::copy(chars + pos, chars + pos + amount, dest);
}

void Str2::grow(size_t amount)
{
...
Str2& Str2::concat(size_t size, const char* begin, const char* end)
{
...
Str2 Str2::substr(size_t index, size_t length) const
{
